...
public class TaskFour {
    ...
    public static void lastOperation(int firstNumber, String operation, int secondNumber){
        System.out.println("Do you want to cancel the last operation? (true or false)");
